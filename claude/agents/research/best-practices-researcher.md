...
2. **Identify Relevant Skills**:
   ...
   - Frontend/Design → `frontend-design`, `web-animation-design`, `emil-design-engineering`
   - TypeScript/React → `vercel-react-best-design`
...
2. **Organize Discoveries**:
   ...
   - Clearly indicate source: "From skill: vercel-react-best-practices" vs "From official docs" vs "Community consensus"
...
- **Skill-based**: "The vercel-react-best-practices skill recommends..." (highest authority - curated)
