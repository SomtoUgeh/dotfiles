 ...
 *   bun run scripts/create-html.ts --svg diagram.svg --output diagram.html --padding 40
 *
 * Runtimes:
 *   bun run scripts/create-html.ts ...
 *   npx tsx scripts/create-html.ts ...
 *   deno run --allow-read --allow-write scripts/create-html.ts ...
 */
...
Examples:
  ...
  create-html.ts --svg diagram.svg --output diagram.html --background "#fafafa"
`);
}
...
function main(): void {
  ...
  const background =
    args.background ?? extractBackgroundFromSvg(svgContent) ?? "#fafafa";
