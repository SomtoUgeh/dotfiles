...
Use the **skill** tool to load the `cloudflare` skill and help with any Cloudflare development task.
...
1. Determine install location by checking which exists:
   - Local: `.claude/skills/cloudflare/`
   - Global: `~/.claude/skills/cloudflare/`
...
Read the SKILL.md from the skill directory:
- Local: `.claude/skills/cloudflare/SKILL.md`
