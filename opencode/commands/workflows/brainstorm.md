...
Use the **skill** tool to load `shaping` as methodology reference throughout this workflow.
...
Use the **question** tool to ask: "Your requirements seem detailed enough to proceed directly to planning. Should I run `/workflows/plan` instead, or would you like to shape the idea further?"
...
Use the **question** tool to gather the Frame — one question at a time.
...
Gather requirements via the **question** tool, one at a time.
...
Use the **question** tool to pick winning shape based on fit check.
