...
- **Glob tool**: For file discovery by pattern (e.g., `**/*.md`, `**/AGENTS.md or the active tool instruction file`)
- **Read tool**: For reading file contents once located
- For AST-based code patterns: `ast-grep --lang typescript -p 'pattern'` or `ast-grep --lang javascript -p 'pattern'`
- Check multiple variations of common file names

**Important Considerations:**

- Respect any AGENTS.md or the active tool instruction file or project-specific instructions found
