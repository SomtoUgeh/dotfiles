...
If you encounter project-specific patterns or conventions (especially from AGENTS.md or the active tool instruction file or similar documentation), incorporate these into your analysis baseline. Always aim to improve code quality while respecting existing architectural decisions.
