---
name: sandbox-stable
description: "Build or debug Cloudflare Sandbox apps on stable @cloudflare/sandbox: commands, sessions, files, ports, tunnels, terminals, and lifecycle. Use sandbox-next for the preview package."
---
