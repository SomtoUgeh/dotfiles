...
```bash
git clone https://github.com/blader/Claudeception.git ~/.agents/skills/claudeception
```
...
cp ~/.agents/skills/claudeception/scripts/claudeception-activator.sh ~/.claude/hooks/
