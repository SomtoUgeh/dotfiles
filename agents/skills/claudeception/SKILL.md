...
This skill needs file read/write/edit access, search access, web research access, skill-loading support, and a way to ask the user for approval. Tool permissions are configured by the active agent runtime, not by this shared skill.
...
- **User-wide skills**: `~/.agents/skills/[skill-name]/SKILL.md`
