...
Location: ~/.agents/skills/expertise/{suggested-name}/
```
...
```bash
# Create structure
mkdir -p ~/.agents/skills/expertise/{domain-name}
mkdir -p ~/.agents/skills/expertise/{domain-name}/workflows
mkdir -p ~/.agents/skills/expertise/{domain-name}/references
...
# Verify structure
ls -R ~/.agents/skills/expertise/{domain-name}
```
...
- [ ] Platform-specific considerations included
- [ ] Located in ~/.agents/skills/expertise/{domain-name}/
