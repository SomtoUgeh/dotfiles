<overview>
Skills improve through iteration and testing. This reference covers evaluation-driven development, Agent A/B testing patterns, and XML structure validation during testing.
</overview>
...
<step_3>
**Establish baseline**: Measure the agent's performance without the skill.
</step_3>
...
<insight>
Modern agent models understand skill format natively. Simply ask the agent to create a skill and it will generate properly structured SKILL.md content.
</insight>
</creating_skills>
...
<haiku_testing>
**Fast, economical model** (fast, economical)
...
<opus_testing>
**Strong reasoning model** (powerful reasoning)
...
- **the agent confidence**: Does the agent seem uncertain?
