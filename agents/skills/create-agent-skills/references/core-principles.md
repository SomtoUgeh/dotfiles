...
<description>
Skills use pure XML structure for consistent parsing, efficient token usage, and improved the agent performance.
</description>
...
<principle_summary>
<xml_structure>
Use pure XML structure for consistency, parseability, and the agent performance. Required tags: objective, quick_start, success_criteria.
</xml_structure>
