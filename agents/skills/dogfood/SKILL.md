...
This skill needs shell access to run `agent-browser` and create report artifacts. Tool permissions are configured by the active agent runtime, not by this shared skill.
