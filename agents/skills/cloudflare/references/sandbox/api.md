...
Read the selected track for execution, file, process, preview, and terminal APIs. Verify optional code-interpreter and bucket-mount APIs against the installed package types; do not assume every session exposes the whole Sandbox API.
