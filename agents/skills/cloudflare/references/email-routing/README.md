...
Receive, forward, reject, parse, archive, and reply to mail with Email Routing and Workers. Select the sending API deliberately: the MIME-based send_email binding and the newer structured Email Service API are different contracts.
