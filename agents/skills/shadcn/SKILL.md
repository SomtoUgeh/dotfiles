...
This skill needs shell access to run the shadcn CLI through the project's package runner (`npx`, `pnpm dlx`, or `bunx`). Tool permissions are configured by the active agent runtime, not by this shared skill.
