...
This skill needs shell access to launch desktop apps and run `agent-browser` or `npx agent-browser`. Tool permissions are configured by the active agent runtime, not by this shared skill.
